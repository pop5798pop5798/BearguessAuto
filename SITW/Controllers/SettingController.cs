...
namespace SIT.Controllers
{
    ...
    public class SettingController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<ActionResult> nabobIndex()
        {
            ...
            gameblol.topicsettingList = gameblol.topicsettingList.Where(x => x.gametype == 1 && x.Model == 1).ToList();
        ...
        public async System.Threading.Tasks.Task<ActionResult> GuessIndex()
        {
            SettingListDto gameb = await new SttingRepository().GetTopicSettingList();
            SettingListDto gameblol = new SettingListDto();
            SettingListDto gamebdota2 = new SettingListDto();
            SettingListDto gamebcsgo = new SettingListDto();
            gameblol.topicsettingList = gameb.topicsettingList.Where(x => x.gametype == 1 && x.Model == 2).ToList();
            gamebdota2.topicsettingList = gameb.topicsettingList.Where(x => x.gametype == 4 && x.Model == 2).ToList();
            gamebcsgo.topicsettingList = gameb.topicsettingList.Where(x => x.gametype == 2 && x.Model == 2).ToList();
            ViewData["lolList"] = gameblol;
            ViewData["Dota2List"] = gamebdota2;
            ViewData["CSGOList"] = gamebcsgo;
            return View();
        }


        public ActionResult _GuessLol(SettingListDto stting)
        {
        ...
        public ActionResult _GuessDota2(SettingListDto stting)
        {
        ...
        [AllowAnonymous]
        public async System.Threading.Tasks.Task<ActionResult> _GtopicCreate(SettingListDto model, int? index,int game)
        {
