...
namespace SITW.Models.ViewModel
{
    public class GamePostViewModel
    {
        ...
        public SettingListDto settingList { get; set; }
        ...
        public RecommendStart recommendstr { get; set; }
        public int livevalid { get; set; }
        public string t_tilte { get; set; }
        public string c_choice1 { get; set; }
        public string c_choice2 { get; set; }
        public string href { get; set; }
        public int vedeotype { get; set; }
