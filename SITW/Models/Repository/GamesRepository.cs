...
namespace SITW.Models.Repository
{
    public class GamesRepository
    {
        ...
        public async System.Threading.Tasks.Task<List<gameDto>> GetPayGameList()
        {
            //List<gameDto> gameList = null;
     


            return await PayreflashGameListAsync();
        }
        ...
        public async System.Threading.Tasks.Task<gameDto> reLiveGameListAsync(int id)
        {
            gameDto game = null;
            SetWinnerReq swq = new SetWinnerReq();
            swq.gameSn = id;
            HttpResponseMessage response = await client.PostAsJsonAsync("api/gamesLive", swq);
        ...
        public async System.Threading.Tasks.Task<List<gameDto>> PayreflashGameListAsync()
        {
            List<gameDto> gameList = null;
            HttpResponseMessage response = await client.GetAsync("/api/gamesPay");
            if (response.IsSuccessStatusCode)
            {
                gameList = await response.Content.ReadAsAsync<List<gameDto>>();
            }
        ...
        public async System.Threading.Tasks.Task<gameDto> CreateLive(gameDto game)
        {
            HttpResponseMessage response = await client.PostAsJsonAsync("api/PostgameLive", game);
            var result = await response.Content.ReadAsStringAsync();
            JavaScriptSerializer json_serializer = new JavaScriptSerializer();
            game = json_serializer.Deserialize<gameDto>(result);
            response.EnsureSuccessStatusCode();
        ...
        public async System.Threading.Tasks.Task<bool> reopenLive(StartBetReq sbr)
        {
            HttpResponseMessage response = await client.PostAsJsonAsync("api/reopenLive", sbr);
        ...
        public async System.Threading.Tasks.Task<bool> setLiveClose(StartBetReq sbr)
        {
            HttpResponseMessage response = await client.PostAsJsonAsync("api/setLiveClose", sbr);
        ...
        public async System.Threading.Tasks.Task<bool> deleteLiveClose(StartBetReq sbr)
        {
            HttpResponseMessage response = await client.PostAsJsonAsync("api/deleteLiveClose", sbr);
            new AssetsRepository().AddLiveAssetsByRollback(sbr.topicSn);
            await reflashGameListAsync();
            return response.IsSuccessStatusCode;

        }

        public async System.Threading.Tasks.Task<bool> deletePayLiveClose(StartBetReq sbr)
        {
            HttpResponseMessage response = await client.PostAsJsonAsync("api/PayLiveClose", sbr);
            new AssetsRepository().AddLiveAssetsPayByRollback(sbr.topicSn);
            //await reflashGameListAsync();
            return response.IsSuccessStatusCode;
        ...
        public async System.Threading.Tasks.Task<aJaxDto> pays(StartBetReq sbr, byte? betmodel)
        {
           ...
           /* if (betmodel == 5)
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                {
                    case 10:                   
                        new AssetsRepository().AddGuessAssetsByPay(payoutList);
                        break;                 
                    default:
